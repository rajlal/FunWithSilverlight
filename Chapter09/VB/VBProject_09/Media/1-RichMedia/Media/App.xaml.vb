...
Partial Public Class App
    ...
    Private Sub Application_Startup(sender As Object, e As StartupEventArgs) Handles Me.Startup
        ...
        Dim sChoice As String = "1"

        Select Case (sChoice)
            Case "0"
                Me.RootVisual = New index()
            Case "1"
                Me.RootVisual = New pageMedia()
            Case "2"
                Me.RootVisual = New pageMediaState()
            Case "3"
                Me.RootVisual = New pageVideoBrush()
            Case "4"
                Me.RootVisual = New pageSetSource()
        End Select
...
End Class   '   App
' End Namespace   '   Media
' ..\Project_09\Media\1-RichMedia\Media\App.xaml.cs
