...
Partial Public Class App
    ...
    Private Sub Application_Startup(sender As Object, e As Startupeventargs) Handles Me.Startup
        ...
        Select Case (schoice)
            ...
            Case "1"
                Me.RootVisual = New TestLogin()
            Case "2"
                Me.RootVisual = New PageLoginStyle()
            Case "3"
                Me.RootVisual = New PageTemplate()
            Case "4"
                Me.RootVisual = New PageTemplateVSM()
        End Select
...
End Class   '   App
' End Namespace
' ..\ExtendControl\E\ExtendControl\ExtendControl\1-CustomizeControl\App.xaml.cs
