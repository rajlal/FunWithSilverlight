...
Partial Public Class App
    ...
    Private Sub Application_Startup(sender As Object, e As StartupEventArgs) Handles Me.Startup
        ...
        Dim ebackColor As String = "green"


        For Each key As String In e.InitParams.Keys

            If (key = "StartValue") Then
                startValue = Convert.ToInt32(e.InitParams(key).ToString())
            End If

            If (key = "BackgroundColor") Then
                ebackColor = e.InitParams(key).ToString()
            End If
        Next    '   key

        Me.RootVisual = New MainPage(startValue, ebackColor)
...
' ..\Project_07\ASPAJAX\2-ASPUserControl\FunBadge\App.xaml.cs
