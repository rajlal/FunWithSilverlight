...
Partial Public Class PageUpdate
    ...
    Private Sub UpdateResource_Click(sender As Object, e As RoutedEventArgs)

        svcContext.UpdateObject(resourceGrid.SelectedItem)
        ' Save back
        Save()
    End Sub '   UpdateResource_Click
    ...
    Private Sub Save()
        ...
        updateResource.Content = "Saving..."
        updateResource.IsEnabled = False
    End Sub '   Save
    ...
    Private Sub OnChangesSaved(result As IAsyncResult)
        ...
        Sub()
            ...
            Finally
                ...
                updateResource.Content = "Update"
                updateResource.IsEnabled = True
            End Try
        End Sub
        )
    ...
    End Sub '   Home_Click
End Class   '   PageUpdate:
' End Namespace   '   AdoDataServiceClient
' ..\Project_07\ASPAJAX\4-AdoDataService\AdoDataServiceClient\PageUpdate.xaml.cs
