...
' Namespace AdoDataServiceClient
    ...
    Public Partial Class App
        ...
        private Sub Application_Startup(sender As Object, e As StartupEventArgs) Handles Me.Startup
             ...
             Me.RootVisual = New PageCreate()
          '  this.RootVisual = new Toc()
          '  this.RootVisual = new PageRead()
          '  this.RootVisual = new PageUpdate()
          '  this.RootVisual = new PageDelete()
...
' ..\Project_07\ASPAJAX\4-AdoDataService\AdoDataServiceClient\App.xaml.cs
