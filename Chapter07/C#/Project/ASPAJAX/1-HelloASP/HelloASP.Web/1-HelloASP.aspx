<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="1-HelloASP.aspx.cs" Inherits="_2_HelloASP.Web.__HelloASP" %>
...
<body>
    <form id="form1" runat="server" style="height:100%">
           <div class="Content">
    <div  class="ApplicationContainer"  id="Div1">
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">
		  <param name="source" value='<asp:Literal id="SilverlightFromASPCode" runat="server"/>'/>
