...
Partial Public Class App
    ...
    Private Sub Application_Startup(sender As Object, e As StartupEventArgs) Handles Me.Startup
        ...
        Dim sChoice As String = "3"

        Select Case (sChoice)
            Case "0"
                Me.RootVisual = New index()
            Case "1"
                Me.RootVisual = New PageRecordAudio()
            Case "2"
                Me.RootVisual = New PageRecordVideo()
            Case "3"
                Me.RootVisual = New PageScreenshotVideo()
        End Select
...
' ..\Project_10\AdvancedMedia\3-Webcam\WebCam\App.xaml.cs
