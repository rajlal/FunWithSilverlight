...
namespace ExpressionMediaPlayer
{
    ...
    public partial struct TimeCode : IComparable, IComparable<TimeCode>, IEquatable<TimeCode>
    {
        ...
        public static TimeCode operator +(TimeCode time1, TimeCode time2)
        {
            TimeCode time3 = new TimeCode(time1.absoluteTime + time2.absoluteTime, time1.FrameRate);
            if (time3.absoluteTime >= time1.MaxValue)
            {
                throw new OverflowException(Resources.Smpte12MOverflowException);
            }
        ...
        {
            if (time1.absoluteTime < time2.absoluteTime)
            {
                return true;
            }
        ...
        public static bool operator ==(TimeCode time1, TimeCode time2)
        {
            Object t1 = time1 as Object;
            Object t2 = time2 as Object;
            if (t1 != null && t2 != null)
            {
                double diff = Math.Abs(time1.absoluteTime - time2.absoluteTime);
        ...
        {
            TimeCode timeCode = new TimeCode(absoluteTime, frameRate);
    ...
    {
        public static string ReadableTime(this TimeSpan ts)
        {
