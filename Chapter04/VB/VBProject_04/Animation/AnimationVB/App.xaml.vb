...
Partial Public Class App
    ...
    Private Sub Application_Startup(sender As Object, e As Startupeventargs) Handles Me.Startup
        ...
        Select Case (sChoice)
            ...
            Case "1"
                Me.RootVisual = New PageDoubleAnimation()
            Case "2"
                Me.RootVisual = New PagePointAnimation()
            Case "3"
                Me.RootVisual = New PageColorAnimation()
            Case "4"
                Me.RootVisual = New PageKeyframeAnimation()
        End Select
...
' End Namespace 
' ..\Animation\Animation\App.xaml.cs
