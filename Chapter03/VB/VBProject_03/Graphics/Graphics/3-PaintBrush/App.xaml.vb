...
Partial Public Class App
    ...
    Private Sub Application_Startup(sender As Object, e As Startupeventargs) Handles Me.Startup
        ...
        Select Case (schoice)
            ...
            Case "1"
                Me.RootVisual = New PageMediaBrush()
            Case "2"
                Me.RootVisual = New PageLinearGradient()
            Case "3"
                Me.RootVisual = New PageRadialGradient()
            Case "4"
            Case "5"
        End Select
...
' End Namespace 
' ..\Graphics\G\Graphics\Graphics\3-PaintBrush\App.xaml.cs
