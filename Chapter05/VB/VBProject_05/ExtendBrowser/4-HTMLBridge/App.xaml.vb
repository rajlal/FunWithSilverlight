...
' Namespace HTMLBridge
    ...
    Public Partial Class App
        ...
        Select (sChoice)
            ...
            Case "1"
                Me.RootVisual = New PageAccessHTML()
            Case "2"
                Me.RootVisual = New PageAccessDOM()
            Case "3"
                Me.RootVisual = New PageAccessScript()
            Case "4"
                Me.RootVisual = New PageAccessSilverlight()
        End Select
...
' ..\Project_05\ExtendBrowser\4-HTMLBridge\App.xaml.cs
