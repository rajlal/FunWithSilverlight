...
' Namespace LocalStorage
    ...
    Public Partial Class App
        ...
        Dim sChoice As String = "5"

        Select Case (sChoice)
            Case "0"
                Me.RootVisual = New Page()
            Case "1"
                Me.RootVisual = New PageOpenFileDialog()
            Case "2"
                Me.RootVisual = New PageIsolatedStore()
            Case "3"
                Me.RootVisual = New PageIsolatedLocalFiles()
            Case "4"
                Me.RootVisual = New PageIsolatedEmbeddedFiles()
            Case "5"
                Me.RootVisual = New PageIsolatedSettings()
        End Select
...
' ..\Project_05\ExtendBrowser\3-IsolatedStorage\App.xaml.cs
